...
def init_db():
    ...
    if not db_exists:
        ...
        facilities_data = [
            (1, "Park Skaryszewski", "Aleja Zieleniecka 2, Warszawa", '<iframe width="100%" height="200" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=21.0487,52.2470,21.0527,52.2490&layer=mapnik&marker=52.2480,21.0507" style="border: 1px solid black"></iframe><br/><small><a href="https://www.openstreetmap.org/?mlat=52.2480&mlon=21.0507#map=17/52.2480/21.0507">Zobacz większą mapę</a></small>', "Poczuj klasykę tenisa na naszych 6 kortach ziemnych w sercu zielonej Pragi!"),
            (2, "Korty Solec", "ul. Solec 25, Warszawa", '<iframe width="100%" height="200" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=21.0370,52.2310,21.0410,52.2330&layer=mapnik&marker=52.2320,21.0390" style="border: 1px solid black"></iframe><br/><small><a href="https://www.openstreetmap.org/?mlat=52.2320&mlon=21.0390#map=17/52.2320/21.0390">Zobacz większą mapę</a></small>', "Graj przez cały rok! Korty ziemne i twarde w hali czekają nad Wisłą."),
            (3, "Korty Paryska", "ul. Paryska 10, Warszawa", '<iframe width="100%" height="200" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=21.0620,52.2410,21.0660,52.2430&layer=mapnik&marker=52.2420,21.0640" style="border: 1px solid black"></iframe><br/><small><a href="https://www.openstreetmap.org/?mlat=52.2420&mlon=21.0640#map=17/52.2420/21.0640">Zobacz większą mapę</a></small>', "Doświadcz różnorodności! Korty ziemne i unikalny kort trawiasty na Saskiej Kępie.")
        ]
