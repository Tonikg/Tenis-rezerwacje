...
<head>
    ...
    <style>
        body { font-family: Helvetica, sans-serif; margin: 4%; background-color: #f4f4f4; color: #333; }
    ...
    <header>
        <h1><a href="/" style="color: white; text-decoration: none;">System Rezerwacji Kortów</a></h1>
			...
			<li><a href="/our-centers">Nasze Ośrodki</a></li> 
                        ...
                        <!-- OPCJONALNIE: Jeśli chcesz, aby niezalogowani też widzieli zasady, odkomentuj poniższą linię -->
                        <!-- <li><a href="/booking-rules">Zasady Rezerwacji</a></li> -->
                    % end
                </ul>
            </nav>
