%rebase('base_layout.tpl', title='Zasady Rezerwacji', user=user)

<div class="container mt-4">
    <h1>Zasady Rezerwacji Kortów</h1>
    <hr>
    ...
    <ul>
        ...
        <li><strong>Ciągłość rezerwacji:</strong> Zarezerwowane godziny muszą następować bezpośrednio po sobie. Na przykład, jeśli zarezerwujesz kort na godzinę 13:00, kolejne możliwe rezerwacje dla Ciebie w tej sesji to 14:00 i 15:00. Nie można zarezerwować np. 13:00 i 15:00 bez rezerwacji 14:00.</li>
        <li><strong>Anulowanie rezerwacji:</strong>
            <ul>
                <li>Możesz samodzielnie anulować swoje przyszłe rezerwacje poprzez panel "Historia rezerwacji".</li>
    ...
    <p>Dziękujemy za korzystanie z naszego systemu i życzymy udanej gry!</p>
    <p><a href="/" class="btn btn-secondary">Powrót na stronę główną</a></p>
</div>